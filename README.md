...
# aptlist
an attempt by a bad programmer to create a program that lists the package manager APT the avaliable packages. inspired by cargo-seek https://crates.io/crates/cargo-seek
